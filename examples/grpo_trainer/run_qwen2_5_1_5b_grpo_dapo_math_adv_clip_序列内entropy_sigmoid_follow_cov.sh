...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.rollout_data_dir=/data/huaiwenzhang/projects/verl/training_rollout_metrics/grpo_advclip_entropy_both_sigmoid_sequence_prob0.5_+5_RETHINK_settings  \
    trainer.rollout_rank_log_freq=0 \
    trainer.project_name='verl_grpo_qwen2_5_1_5b_gsm8k_math' \
    trainer.experiment_name='grpo_advclip_entropy_both_sigmoid_sequence_prob0.5_+5_RETHINK_settings' \
