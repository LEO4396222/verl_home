...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.advantage_clip.pos_weight_enable=True \
    actor_rollout_ref.actor.policy_loss.advantage_clip.pos_weight_alpha=5.0 \
    ...
    trainer.rollout_data_dir=/data/huaiwenzhang/projects/verl/training_rollout_metrics/grpo_loss_reweight_5_follow_cov \
    trainer.project_name='verl_grpo_qwen2_5_1_5b_gsm8k_math' \
    trainer.experiment_name='grpo_loss_reweight_5_follow_cov' \
