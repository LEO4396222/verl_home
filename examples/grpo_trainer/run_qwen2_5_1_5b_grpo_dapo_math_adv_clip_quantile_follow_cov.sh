...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.advantage_clip.mode=quantile \
    actor_rollout_ref.actor.policy_loss.advantage_clip.enable_clip_high=True \
    actor_rollout_ref.actor.policy_loss.advantage_clip.prob_high_quantile=0.2 \
    actor_rollout_ref.actor.policy_loss.advantage_clip.adv_high_quantile=0.2 \
    actor_rollout_ref.actor.policy_loss.advantage_clip.high_clip_scale=1.0 \
    actor_rollout_ref.actor.policy_loss.advantage_clip.enable_clip_low=Flase \
    actor_rollout_ref.actor.policy_loss.advantage_clip.prob_low_quantile=0.2 \
    actor_rollout_ref.actor.policy_loss.advantage_clip.adv_low_quantile=0.4 \
    actor_rollout_ref.actor.policy_loss.advantage_clip.low_clip_scale=1.0 \
    ...
    trainer.rollout_rank_enable=True \
    trainer.rollout_rank_log_freq=20 \
    trainer.rollout_data_dir=/data/huaiwenzhang/projects/verl/training_rollout_metrics/grpo_advclip_quantile_+0.2pro_+0.2adv_-0.2pro_-0.4adv_seperate_follow_cov \
    trainer.project_name='verl_grpo_qwen2_5_1_5b_gsm8k_math' \
    trainer.experiment_name='grpo_advclip_quantile_+0.2pro_+0.2adv_-0.2pro_-0.4adv_seperate_follow_cov' \
